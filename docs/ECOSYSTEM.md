# ECOSYSTEM.md — moved to dirstral-spec
...
- In-tree (pinned submodule): [`dirstral-spec/docs/ECOSYSTEM.md`](../dirstral-spec/docs/ECOSYSTEM.md)
- Upstream: <https://github.com/dirstral/dirstral-spec/blob/main/docs/ECOSYSTEM.md>
