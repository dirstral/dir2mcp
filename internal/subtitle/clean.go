...
type CleanOptions struct {
	...
	// expected script (wrong-script STT gibberish over non-speech; see
	// ScriptGuard). A cue with any digit or any expected-script letter survives.
	// Nil/inactive = no drops.
	Script *ScriptGuard
